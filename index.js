...
const allowedOrigins = ['http://localhost:3000', 'https://fittrack-jb6l8wkvu-ayushs-projects-163efa4a.vercel.app']; //Frontend is in "http://localhost:3000". Allow access to backend running on localhost8000.
